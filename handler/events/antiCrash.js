...
fs.readFile(config.bot_settings.path+'logs/antiCrash/errorLog.txtt', 'utf8', (err, data) => {
var abc = fs.createWriteStream(config.bot_settings.path+`logs/antiCrash/errorLog.txtt`);
abc.write(`${data} \n`)
